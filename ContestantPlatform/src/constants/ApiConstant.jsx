...
//hints
export const APi_GET_CHALLENGES_HINTS = "/api/hint"; //+id
export const API_UNLOCK_HINTS = "/api/hint/unlock"; //unlock hint
export const API_GET_UNLOCKED_HINT = "/api/v1/unlocks"; //get unlock

//Scoreboard
export const API_SCOREBOARD_TOP_STANDINGS = "/api/scoreboard/top/200";

//Ticket
export const API_LIST_TICKET = "/api/ticket/tickets-user";
export const API_DETAIL_TICKET = "/api/ticket/tickets"; //details
export const API_TICKET_CREATE_BY_USER = "/api/ticket/sendticket";
...
export const API_TEAM_POINT = "/api/team/contestant";
...
//config
export const API_GET_DATE_CONFIG = "/api/Config/get_date_config";
export const API_GET_REGISTER_STATE = "/api/get_register_config";

//notifications
export const API_GET_NOTIFICATION = "/api/notifications";

//action_logs
export const API_ACTION_LOGS = "/api/v1/action_logs";
export const API_GET_ACTION_LOGS = "/api/ActionLogs/get-logs";
export const API_POST_ACTION_LOGS = "/api/ActionLogs/save-logs";
