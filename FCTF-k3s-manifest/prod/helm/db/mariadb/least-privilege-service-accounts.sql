...
GRANT SELECT, INSERT ON ctfd.field_entries TO 'contestant_be'@'%';
GRANT SELECT, UPDATE ON ctfd.challenges TO 'contestant_be'@'%';
...
GRANT SELECT, INSERT ON ctfd.submissions TO 'contestant_be'@'%';
GRANT SELECT, INSERT ON ctfd.solves TO 'contestant_be'@'%';
GRANT SELECT, INSERT ON ctfd.awards TO 'contestant_be'@'%';
