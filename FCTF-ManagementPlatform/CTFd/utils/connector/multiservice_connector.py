            ...
            try:
                ...
                try:
                    ...
                    new_version = ChallengeVersion(
                        ...
                        cpu_limit=str(challenge.cpu_limit) if challenge.cpu_limit is not None else None,
                        cpu_request=str(challenge.cpu_request) if challenge.cpu_request is not None else None,
                        memory_limit=str(challenge.memory_limit) if challenge.memory_limit is not None else None,
                        memory_request=str(challenge.memory_request) if challenge.memory_request is not None else None,
