...
class ChallengeAnalytics(Resource):
    ...
    def get(self):
        ...
        fails_sub = (
            db.session.query(
                Fails.challenge_id.label("challenge_id"),
        ...
        hint_usage_sub = (
            db.session.query(
                Hints.challenge_id.label("challenge_id"),
                func.count(HintUnlocks.id).label("hint_usage"),
            )
            .join(Hints, HintUnlocks.hint_id == Hints.id)
        ...
        attempts_sub = (
            db.session.query(
                Submissions.challenge_id.label("challenge_id"),
