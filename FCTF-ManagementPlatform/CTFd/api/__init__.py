...
# from CTFd.api.v1.notifications import notifications_namespace  # notifications API disabled
...
# CTFd_API_v1.add_namespace(notifications_namespace, "/notifications")  # removed as per hide requirement
