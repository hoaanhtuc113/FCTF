    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <h1 className={`text-2xl font-mono font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'
            }`}>
            [#] Running Instances
          </h1>
          <button
            ...
            disabled={refreshing}
            className={`flex items-center gap-2 px-4 py-2 rounded font-mono text-sm border transition-colors ${refreshing
                ? theme === 'dark'
      ...
      {instances.length === 0 ? (
        <div className={`text-center py-12 border rounded-lg ${theme === 'dark'
        ...
        <div className="overflow-x-auto">
          <table className={`w-full font-mono text-sm border-collapse ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
            }`}>
            <thead>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-2" style={{ width: '8%' }}>
                      <span className={`px-2 py-1 rounded text-xs border ${theme === 'dark'
                    ...
                    <td className="py-3 px-2" style={{ width: '17%' }}>
                      <div className="flex justify-end gap-1">
                        <button
                          ...
                          className={`px-2 py-1.5 text-xs rounded transition-colors ${theme === 'dark'
                        ...
                        {instance.status === 'Running' && (
                          <>
                            <button
                              ...
                              className={`px-2 py-1.5 text-xs rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${theme === 'dark'
