...
| --- | --- | --- |
| Access | User entry and challenge runtime ingress | Ingress NGINX, Admin Portal, Contestant Portal, Challenge Gateway |
| Control | Competition and deployment control APIs | Contestant Service, Deployment Center |
