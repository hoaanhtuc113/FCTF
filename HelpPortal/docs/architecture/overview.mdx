...
:::important[Latency and reliability are intentionally separated]
Keep user request paths synchronous and fast, while routing deployment-heavy operations through async queue and workflow boundaries.
:::
