    ...
    public class ScoreHelper
    {
        ...
        public async Task<int> GetUserScore(User user, bool admin = false)
        {
            using (var context = new AppDbContext(dbOptions))
            {
                ...
                if (!admin)
                {
                    var freezeConfig = await context.Configs
                        .AsNoTracking()
                ...
                var solvesScore = await context.Solves
                    .AsNoTracking()
                ...
                var awardsScore = await context.Awards
                    .AsNoTracking()
        ...
        public async Task<int?> GetUserPlace(User user, bool admin = false)
        {
            using (var context = new AppDbContext(dbOptions))
            {
                ...
                var solvesScores = await context.Solves
                    .AsNoTracking()
                ...
                var awardsScores = await context.Awards
                    .AsNoTracking()
        ...
        public async Task<int> GetTeamScore(Team team, bool admin = false)
        {
            using (var context = new AppDbContext(dbOptions))
            {
                ...
                var teamMemberIds = await context.Users
                    .AsNoTracking()
        ...
        public async Task<int?> GetTeamPlace(Team team, bool admin = false)
        {
            using (var context = new AppDbContext(dbOptions))
            {
                ...
                var teamsWithMembers = await context.Teams
                    .AsNoTracking()
                    .Select(t => new
                    {
                        TeamId = t.Id,
