          ...
          <div className="mb-4 space-y-3">
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-16 py-2 rounded border font-mono text-sm ${
                  theme === 'dark'
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className={`border-b ${
                  ...
                  <th
                    className={`p-3 font-mono cursor-pointer hover:bg-gray-700/50 ${
                  ...
                  <th className={`p-3 font-mono text-left ${
                    theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                  }`}>
                    TEAM
                  </th>
                  <th
                    className={`p-3 font-mono text-right cursor-pointer hover:bg-gray-700/50 ${
                      theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                    }`}
              ...
              <tbody>
                <AnimatePresence mode="wait">
                  {paginatedScores.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={3} className={`p-8 text-center font-mono text-xs ${
                        theme === 'dark' ? 'text-gray-500' : 'text-gray-600'
                      }`}>
                        {'>'} No teams found
                      </td>
                ...
                <div className="flex gap-1">
                  {getPageNumbers(totalPages, currentPage).map((item, idx) => (
                    <button
                      ...
                      disabled={item === "…"}
                      className={`w-8 h-8 flex items-center justify-center rounded font-mono text-xs ${
                        currentPage === item
                          ? theme === 'dark'
